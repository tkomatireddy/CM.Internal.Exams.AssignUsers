    ...
    public class Catalog_DAC
    {
        ...
        internal int UpdateUserDetails(long userId)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                string query = " update cat_UserDetails set ended_time=getdate(),submitted_type='FINISH',tot_Sec=DATEDIFF(SECOND,started_time,getdate()) where userid=@userId and role_id=1";
                cmd.CommandText = query;
        ...
        public DataTable getTagValues()
        {
            ...
            string query = " SELECT TagId, TagValue FROM Cat_TagValues_Master where IsActive=1";
            cmd.CommandText = query;
        ...
        public DataTable getMarcQuesctions(int QIId, long UserId)
        {
            ...
            string query = " select a.MarcId,a.Question,a.Answar as Answer, isnull(b.Answar,'select') as UsrAnswer, b.Result,b.Comments " +
